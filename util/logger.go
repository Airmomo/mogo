...
func (ll *Logger) Panic(format string, v ...interface{}) {
	...
	msg := fmt.Sprintf("[LOG-Panic] "+format, v...)
	ll.Println(msg)
	os.Exit(0)
}
...
func (ll *Logger) Error(format string, v ...interface{}) {
	...
	msg := fmt.Sprintf("[LOG-Error] "+format, v...)
	ll.Println(msg)
}
...
func (ll *Logger) Warning(format string, v ...interface{}) {
	...
	msg := fmt.Sprintf("[LOG-Warn] "+format, v...)
	ll.Println(msg)
}
...
func (ll *Logger) Info(format string, v ...interface{}) {
	...
	msg := fmt.Sprintf("[LOG-Info] "+format, v...)
	ll.Println(msg)
}
...
func (ll *Logger) Debug(format string, v ...interface{}) {
	...
	msg := fmt.Sprintf("[LOG-Debug] "+format, v...)
	ll.Println(msg)
}
